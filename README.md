...
1. [Monarchs_winter.csv](FullAnnualCycleModel_2004-2018/Monarchs_winter.csv): Data on overwintering monarch aggregations, 2004-2018. 
...
2. [Covariates_County.txt](FullAnnualCycleModel_2004-2018/Covariates_County.txt): Covariate values associated with each county on the summer breeding range, in the U.S. and Canada.
...
3. [Covariates_Year.csv](FullAnnualCycleModel_2004-2018/Covariates_Year.csv): Annual covariate values, 2004-2018.
    - yr: year
...
4. [Covariates_CountyYear.csv](FullAnnualCycleModel_2004-2018/Covariates_CountyYear.csv): Annual covariate values associated with each county on the summer breeding range, in the U.S. and Canada, 2004-2018.
    - county.ind: a unique index identifying each county (1:545)
    - state.county: combined state-county FIPS code
    - yr: year
    - glyphosate: estimated proportion of corn and soy crops in each county sprayed with glyphosate
    - summer.pcp: percent of normal cumulative precipitation (mm) between Apr and Aug in each county
5. [Covariates_CountyWeek.csv](FullAnnualCycleModel_2004-2018/Covariates_CountyWeek.csv): Weekly covariate values associated with each county on the summer breeding range, in the U.S. and Canada, 2004-2018.
    - county.ind: a unique index identifying each county (1:545)
    - state.county: combined state-county FIPS code
    - yr: year
    - wk: week (16-24)
