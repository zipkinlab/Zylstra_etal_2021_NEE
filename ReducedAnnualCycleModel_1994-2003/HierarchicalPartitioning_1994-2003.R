...
#Running summer submodels with different combinations of covariate "groups" 
#Using hierarchical partitioning methods to calculate percent of explained variation in summer counts attributable to each covariate group
###################################################################################################################################
