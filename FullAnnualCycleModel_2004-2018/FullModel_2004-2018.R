...
#------------------------------------------------------------#
# Standardizing annual covariate for winter model
#------------------------------------------------------------#   
...
#------------------------------------------------------------#
# Format supercolony*year covariate
#------------------------------------------------------------#   
...
#County-year-week covariates 
  X_county <- as.matrix(cyw[,c('feb','spGDD','spGDD2','spPCP','spPCP2','avgGDD','diffGDD','diffGDD2',
...
#-Save----------------------------------------------------------------#
  ...
  date <- Sys.Date()
  file_str <- paste0('GitHubtest_FACM_2004-2018','_',date,'.Rdata')

  save(out,sessionInfo,
       sccount.mn,sccount.mn.p,sccount.sd,sccount.sd.p,
       area.mn,area.mn.p,area.sd,area.sd.p,
       X_survey,X_county,X_winter,summer,winter,cyw,file=file_str)  
